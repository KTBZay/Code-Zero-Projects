    ...
    setTimeout(() => {
        ...
        if(bots.A.setActiveBot === true){
            ...
            setTimeout(() => {
                ...
                console.log(`[System]: bot cretaed you can view it at ./app/projects/${bots.A.name}/`)
            }, 10000);
        }else
        if(bots.B.setActiveBot === true){
            ...
            setTimeout(() => {
                ...
                console.log(`[System]: bot cretaed you can view it at ./app/projects/${bots.B.name}/`)
            }, 10000);
        }else{
...
function startProjectChecker(){
    const fs= require('node:fs')
    console.log(fs.readdirSync(`./app/projects/`))
}
function startUserChecker(){
    console.log(fs.readdirSync(`./app/Users/`))
}
