...
setTimeout(() => {
    ...
    FileCreator(`${UserData.User_Project_Data.path}/discord_bot.js`,
        `const {Client} = require('discord.js') \n
             ...
             client.on('message', (msg) => { if(msg.content === "${configuration.Discord_Bot_Token}ping"){msg.reply('Pong')}});\n
             client.on('message', (msg) => { if(msg.content === "${configuration.Discord_Bot_Token}cVersion"){msg.reply('1.0.3')}});\n
             client.on('message', (msg) => { if(msg.content === "${configuration.Discord_Bot_Token}Support"){msg.reply('Get your questions answered ${UserData.Discord_Support_Link} or Email us at ${UserData.Public_Contact_Email}')}});\n
